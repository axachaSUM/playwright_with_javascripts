...
export const deliveryAddress = async (page) => {
    ...
    await page.getByPlaceholder('Building access code, parking suggestions, etc').fill('Special Instruction');
    await page.getByPlaceholder('eg. Home, Flat, Cottage...').fill('New Address');
    await page.waitForTimeout(1000);
